...
parser.add_argument('--test_iteration', default=5, type=int) #测试的时候测试几次
...
parser.add_argument('--random_seed', default=3132, type=int)
# optional parameters
...
parser.add_argument('--policy_delay', default=5, type=int) #每5步更新一次
...
directory = directory = 'models/' + "TD3_BipedalWalkerHardCore" + '/'
...
class TD3():
    ...
    def update(self):
        ...
        if self.num_training % 500 == 0:
            print("====================================")
            print("model has been updated for {} times...".format(self.num_training))
            print("====================================")
        #现在不做这么多MGBD了，每一步只做一次             #只用update num_iteration次 原代码给的10  相当于做10次MBGD？
        ...
        if self.num_training % args.policy_delay == 0:                                      #延迟更新
            # if self.num_actor_update_iteration % 500 == 0:
            #     print("====================================")
            #     print("model has been softupdated for {} times...".format(self.num_actor_update_iteration))
            #     print("====================================")
            # Compute actor loss:
    ...
    if args.mode == 'test':
        ...
        for i in range(args.test_iteration):
            ...
            for t in count():
                ...
                if done or t ==2000 :
                    print("Ep_i \t{}, the sum_reward is \t{:0.2f}, the step is \t{}".format(i, sum_reward, t))
                    sum_reward = 0
                    break
                state = next_state
        ...
        for i in range(args.num_iteration):                                                                     #默认5000次
            ...
            for t in range(2000):
                ...
                if done or t == args.max_episode -1:
                    agent.writer.add_scalar('sum_reward', sum_reward, global_step=i)
